      ...
      <div className="flex-1">
        <div className="flex justify-between text-base sm:text-2xl mb-4">
          ...
          <select
            ...
            className="border-2 mt-[20%] lg:mt-1 xl:mt-1 border-gray-300 dark:border-gray-600 text-sm px-2 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded"
          >
