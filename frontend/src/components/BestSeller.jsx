  ...
  return (
    <div className='my-10 bg-[#F9E6E4] dark:bg-gray-900 transition-colors duration-300 pb-20'>
      ...
      <div className='text-center py-8 dark:text-white'>
                ...
                <h2 className=' prata-regular text-4xl md:text-6xl font-bold text-[#414141] mb-4'>
                  - BEST SELLERS -
                </h2>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 gap-y-6 px-20 mt-10'>
